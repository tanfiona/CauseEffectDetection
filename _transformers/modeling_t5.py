...
from .modeling_bert import ViterbiDecoder
...
@add_start_docstrings(
    """T5 Model with a token classification head on top (a linear layer on top of
...
class T5ForTokenClassification(T5PreTrainedModel):
    def __init__(self, config):
        ...
        self.dropout_prob = 0.1 #config.hidden_dropout_prob
