...
from _transformers.commands import BaseTransformersCLICommand
...
class ConvertCommand(BaseTransformersCLICommand):
    ...
    def run(self):
        if self._model_type == "bert":
            try:
                from _transformers.convert_bert_original_tf_checkpoint_to_pytorch import (
            ...
            from _transformers.convert_openai_original_tf_checkpoint_to_pytorch import (
            ...
            try:
                from _transformers.convert_transfo_xl_original_tf_checkpoint_to_pytorch import (
            ...
            try:
                from _transformers.convert_gpt2_original_tf_checkpoint_to_pytorch import (
            ...
            try:
                from _transformers.convert_xlnet_original_tf_checkpoint_to_pytorch import (
            ...
            from _transformers.convert_xlm_original_pytorch_checkpoint_to_pytorch import (
